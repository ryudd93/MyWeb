...
<body>
	...
	<h3>formatNumber -> 숫자의 자리수를 지정</h3>
	...
	<hr/>
	<h3>formatDate -> 날짜형(반드시)을 지정된 날짜 형태로 변경</h3>
	...
	<hr/>
	<h3>parseNumber -> 문자를 숫자형으로 변경 가능</h3>
	...
	<fmt:parseNumber var="d06" value="1,1000.00" pattern="0,000.00" />
	${d06 }
